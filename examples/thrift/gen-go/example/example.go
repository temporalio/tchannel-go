...
func (p *FirstClient) Echo(ctx context.Context, msg string) (_r string, _err error) {
	var _args5 FirstEchoArgs
	_args5.Msg = msg
	var _result7 FirstEchoResult
	var _meta6 thrift.ResponseMeta
	_meta6, _err = p.Client_().Call(ctx, "Echo", &_args5, &_result7)
...
func (p *FirstClient) Healthcheck(ctx context.Context) (_r *HealthCheckRes, _err error) {
	var _args8 FirstHealthcheckArgs
	var _result10 FirstHealthcheckResult
	var _meta9 thrift.ResponseMeta
	_meta9, _err = p.Client_().Call(ctx, "Healthcheck", &_args8, &_result10)
...
func (p *FirstClient) AppError(ctx context.Context) (_err error) {
	var _args12 FirstAppErrorArgs
	var _result14 FirstAppErrorResult
	var _meta13 thrift.ResponseMeta
	_meta13, _err = p.Client_().Call(ctx, "AppError", &_args12, &_result14)
...
func NewFirstProcessor(handler First) *FirstProcessor {
	self15 := &FirstProcessor{NewBaseProcessor(handler)}
	self15.AddToProcessorMap("Echo", &firstProcessorEcho{handler: handler})
	self15.AddToProcessorMap("Healthcheck", &firstProcessorHealthcheck{handler: handler})
	self15.AddToProcessorMap("AppError", &firstProcessorAppError{handler: handler})
	return self15
}
...
func (p *SecondClient) Test(ctx context.Context) (_err error) {
	var _args17 SecondTestArgs
	var _result19 SecondTestResult
	var _meta18 thrift.ResponseMeta
	_meta18, _err = p.Client_().Call(ctx, "Test", &_args17, &_result19)
...
func NewSecondProcessor(handler Second) *SecondProcessor {
	...
	self20 := &SecondProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self20.processorMap["Test"] = &secondProcessorTest{handler: handler}
	return self20
}
